...
function Hero() {
  return (
    <div className="container">
      <div className="row text-center p-5 my-5 border-bottom">
        <h1>
      ...
      <div className="row p-5" style={{lineHeight:'1.8',fontSize:'1.2em'}}>
        <div className="col p-5 mr-5">
          <p>
            ...
            of breaki ng all barriers that traders and investors face in India
            in terms of cost, sup port, and technology. We named the company
          ...
          <p>
            ...
            pow erful ecosystem of investment platforms, contributing over 15%
